...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    //Objetos, cada uno con sus propios ejes
    //Caja
    this.boxAxis = new THREE.AxesHelper (5);
    this.add (this.boxAxis);
    this.box = new MyBox(this.gui, "Dimensiones de la Caja");
    this.add (this.box);

    //Cilindro
    this.cylAxis = new THREE.AxesHelper(5);
    this.add(this.cylAxis);
    this.cyl = new MyCylinder(this.gui, "Dimensiones del Cilindro");
    this.add(this.cyl);

    this.cylAxis.position.x = 7;
    this.cyl.position.x = 7;

    //Cono
    this.coneAxis = new THREE.AxesHelper(5);
    ...
    this.torusAxis.position.y = -7;
    this.torus.position.y = -7;
    ...
    this.icosahedronAxis.position.z = 7;
    this.icosahedron.position.z = 7;
  }
  ...
  update () {
    ...
    this.boxAxis.visible = this.guiControls.axisOnOff;
    this.cylAxis.visible = this.guiControls.axisOnOff;
    this.coneAxis.visible = this.guiControls.axisOnOff;
    this.sphereAxis.visible = this.guiControls.axisOnOff;
    this.torusAxis.visible = this.guiControls.axisOnOff;
    this.icosahedronAxis.visible = this.guiControls.axisOnOff;
