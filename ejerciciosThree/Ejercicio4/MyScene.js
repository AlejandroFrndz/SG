...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.trebol.position.set(4,0,0);

    this.pica = new Pica();
    this.add(this.pica);
    this.pica.position.set(-4,0,0);

    this.columnaTrebol = new ColumnaTrebol();
    this.add(this.columnaTrebol);
    this.columnaTrebol.position.set(-4,4,0);

    this.columnaCorazon = new ColumnaCorazon();
    this.add(this.columnaCorazon);
    this.columnaCorazon.position.set(4,4,0);
